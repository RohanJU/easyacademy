    ...
    items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left "
      >
        ...
        text-course-details-heading-small font-semibold text-gray-800"
          ...
          <p className="text-sm">
            course by <span className="text-blue-600">Easy Academy</span>
          </p>
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[400px]">
          ...
          <div className="p-5">
            ...
            <div className="pt-6 ">
              ...
              <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-600 space-y-1">
                <li>life acess with free updates</li>
